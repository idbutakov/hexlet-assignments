...
class ValidationTest {
    ...
    void testAdvancedValidate() {
        ...
        Map<String, List<String>> notValidFieldsResult = Validator.advancedValidate(address);
        Map<String, List<String>> notValidFieldsExpected = Map.of(
                "country", List.of("length less than 4"),
                "street", List.of("can not be null")
        );
        assertThat(notValidFieldsResult).isEqualTo(notValidFieldsExpected);
    }
    // END
}
